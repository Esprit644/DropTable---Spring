...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Booking booking2 = new Booking("2019-07-12", "17:00", 2, cust2, table2);
        bookingRepository.save(booking2);

        Booking booking3 = new Booking("2019-07-12", "19:00", 2, cust3, table2);
        bookingRepository.save(booking3);

        Booking booking4 = new Booking("2019-07-21", "19:00", 2, cust3, table2);
